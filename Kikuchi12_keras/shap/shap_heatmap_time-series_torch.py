...
def main(tt, pcs):
    ...
    shap_abs = shap_data.sum(axis=(3,4))
    
    shap_val_abs = shap_abs
    ...
    for yy in range(2016, 2023):
        ...
        # save
        plt.savefig(f'/work/gi55/i55233/data/results/bsiso_shap/jja_daily_cmap/{(tt):03}/pc{pcs+1}_{yy}.png', bbox_inches='tight', dpi=200)
        plt.close()
