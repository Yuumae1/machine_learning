...
ipt_train = np.concatenate([olr_ipt_train, u850_ipt_train, h850_ipt_train, pr_wtr_ipt_train], 3)
ipt_test  = np.concatenate([olr_ipt_test, u850_ipt_test, h850_ipt_test, pr_wtr_ipt_test], 3)
