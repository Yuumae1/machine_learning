...
# ==== iteration program ====
lt_box = [0, 5, 10, 15, 20, 25, 30, 35, 40]
#lt_box = np.arange(36)
...
# 各変数を抜いたデータを導入する:
  for kk in range(8):
    ...
    for seed in range(20):
      ...
      np.savez(f'/home/maeda/machine_learning/results/kikuchi-8vals_v1/cor/7vals/wo_{wo_values[kk]}/{(lead_time):03}day/seed{(seed):03}.npz', predict, y_test)
      model.save(f'/home/maeda/machine_learning/results/model/kikuchi-8vals_v1/7vals/wo_{wo_values[kk]}/model_{(lead_time):03}day/seed{(seed):03}.hdf5')
