...
def cnn_model():
    model = Sequential()
    model.add(Conv2D(64, (2, 2), padding='same', input_shape=(64, 64, 5), strides=(2,2), kernel_regularizer=l2(1e-4)))   
    model.add(BatchNormalization())
    model.add(Activation('relu')) 
    model.add(Dropout(0.1))                                                                            
    model.add(Conv2D(128, (2, 2), padding='same', strides=(2,2), kernel_regularizer=l2(1e-4)))                                        
    model.add(BatchNormalization())
    model.add(Activation('relu'))
    model.add(Dropout(0.1))                      
    model.add(Conv2D(256, (2, 2), padding='same', strides=(2,2), kernel_regularizer=l2(1e-4)))                           
    model.add(BatchNormalization())
