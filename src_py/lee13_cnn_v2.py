...
lat = data['lat'][20:42]
lon = data['lon'][16:66]
olr = data['olr'][80:,20:42,16:66]
u850 = data['u850'][80:,20:42,16:66]
#v850 = data['v850'][80:,20:42,16:66]
u200 = data['u200'][80:,20:42,16:66]
#v200 = data['v200'][80:,20:42,16:66]
h850 = data['h850'][80:,20:42,16:66]
pr_wtr = data['pr_wtr'][80:,20:42,16:66]
sst = data['sst'][80:,20:42,16:66]
...
data_file = '/home/maeda/data/bsiso_lee13/lee13_pcs_all.npz'
PC1 = np.load(data_file)['PC1']
...
def cnn_model():
  ...
  model.add(Conv2D(32, (3, 3), padding='same', input_shape=(22, 50, 6), strides=(2,2), kernel_regularizer=l2(0.001)))   
...
def learning_curve(history, lead_time):
  ...
  plt.legend()
  plt.savefig(f'/home/maeda/machine_learning/results/lee13/learning_curve/6vals/{(lead_time):03}day.png')
  plt.close()
...
for lead_time in lt_box:
  ...
  ipt_train = np.stack([olr_ipt_train, u850_ipt_train,  u200_ipt_train,
                         h850_ipt_train, pr_wtr_ipt_train, sst_ipt_train], 3)
  ipt_test  = np.stack([olr_ipt_test, u850_ipt_test,  u200_ipt_test,
                        h850_ipt_test, pr_wtr_ipt_test, sst_ipt_test], 3)
  ...
  for seed in range(1):
    ...
    np.savez(f'/home/maeda/machine_learning/results/lee13/cor/6vals/{(lead_time):03}day/seed{(seed):03}.npz', predict, y_test)
    model.save(f'/home/maeda/machine_learning/results/model/lee13/6vals/model_{(lead_time):03}day/seed{(seed):03}.hdf5')
