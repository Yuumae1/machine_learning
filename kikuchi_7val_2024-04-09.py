...
PC     = np.load(data_file)['rt_PCs'][10:,:2]
...
print(predict.shape)
y_test = sup_test
np.savez('/home/maeda/machine_learning/results/cnn-2d/kikuchi_7vals_' + str(lead_time) + 'day.npz', predict, y_test)
...
# 保存
plt.savefig('/home/maeda/machine_learning/results/cnn-2d/l-curve_kikuchi_7vals_' + str(lead_time) + 'day.png')
plt.close()